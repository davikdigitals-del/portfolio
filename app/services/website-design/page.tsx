          ...
          <div className="space-y-8">
            {[
              ...
              <div key={index} className="glass-card relative">
                <div className="absolute -left-4 top-6 md:-left-6 bg-gradient-to-r from-pink-400 to-rose-400 text-white w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center font-bold text-lg md:text-xl shadow-lg">
                  {process.step}
                </div>
